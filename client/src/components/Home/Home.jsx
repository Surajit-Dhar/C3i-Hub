...
export default function Home() {
  ...
  let source=`https://maps.google.com/maps?ll=26.511434,80.234873&q=kanpur&t=&z=14&ie=UTF8&iwloc=&output=embed`;
  ...
  return (
    <div>
      {loading ? (
        ...
        <div>
          <PageProgress color={"#174c8d"} height={4} />
          ...
          <div name="home" className="home-container">
            <Container className="header">
              <Row>
                ...
                <Col>
                <iframe src={source} style={{height:"100%", width:"100%" }} title="cities"/> 
                </Col>
              </Row>
            </Container>
          </div>
